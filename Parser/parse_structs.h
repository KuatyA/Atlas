...
typedef enum{
    ...
    STATE_BEGIN_EXPR,
    STATE_BEGIN_DECL,
    STATE_BEGIN_BLOCK, //maybe?
    STATE_BEGIN_FUNC,

    STATE_EXPECT_IDENTIFIER,
    STATE_EXPECT_INIT,
    STATE_EXPECT_MODIFIER,
    STATE_EXPECT_TYPE,
    STATE_EXPECT_PARAM,
    STATE_EXPECT_LIST,
    ...
    STATE_EXPECT_UNARY,
    STATE_EXPECT_BINARY,
    STATE_EXPECT_TERNARY,
    STATE_EXPECT_EXPR,

    STATE_EXPECT_STMT,
    STATE_EXPECT_BLOCK,
    STATE_EXPECT_IF_STMT,
    STATE_EXPECT_ELSE,
    STATE_EXPECT_WHILE_STMT,
    STATE_EXPECT_DO_STMT,
    STATE_EXPECT_FOR_STMT,
    STATE_EXPECT_FOR_INIT,
    STATE_EXPECT_SWITCH_STMT,
    STATE_EXPECT_CASE_STMT,
    STATE_EXPECT_CASE_BLOCK,
    STATE_EXPECT_DEFAULT_STMT,
    STATE_EXPECT_MATCH_STMT,
    STATE_EXPECT_MATCH_BLOCK,
    STATE_EXPECT_DEFAULT_MATCH_STMT,
    STATE_EXPECT_DEFER_STMT,
    STATE_EXPECT_IMPORT_STMT,
    STATE_EXPECT_MODULE_STMT,
    STATE_EXPECT_MODULE_LIST,
    STATE_EXPECT_TRY_STMT,
    STATE_EXPECT_CATCH_STMT,
    STATE_EXPECT_RAISE_STMT,
    STATE_EXPECT_SPAWN_STMT,
    STATE_EXPECT_SELECT_STMT,
    STATE_EXPECT_LOCK_STMT,

    STATE_EXPECT_INT_LITERAL,
    STATE_EXPECT_FLOAT_LITERAL,
    STATE_EXPECT_CHAR_LITERAL,
    STATE_EXPECT_STRING_LITERAL,
    STATE_EXPECT_BOOL_LITERAL,
    STATE_EXPECT_VOID_LITERAL
}ParserState;
