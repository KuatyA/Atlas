...
static GrammarRule GRAMMAR_RULES[] = {
    ...
    {NT_STRUCT_DECLARATION, 3, "struct_decl -> TOKEN_KW_STRUCT TOKEN_TYPE_IDENTIFIER struct_body"},
    ...
    {NT_ENUM_DECLARATION, 6, "enum_decl -> TOKEN_KW_ENUM TOKEN_TYPE_IDENTIFIER TOKEN_LBRACE enum_member_list TOKEN_RBRACE TOKEN_SEMICOLON"},
    {NT_ENUM_DECLARATION, 4, "enum_decl -> TOKEN_KW_ENUM TOKEN_TYPE_IDENTIFIER TOKEN_IDENTIFIER TOKEN_SEMICOLON"},
    ...
    {NT_UNION_DECLARATION, 6, "union_decl -> TOKEN_KW_UNION TOKEN_TYPE_IDENTIFIER TOKEN_LBRACE union_member_list TOKEN_RBRACE TOKEN_SEMICOLON"},
    {NT_UNION_DECLARATION, 4, "union_decl -> TOKEN_KW_UNION TOKEN_TYPE_IDENTIFIER TOKEN_IDENTIFIER TOKEN_SEMICOLON"},
